...
command = sys.argv[1]
# if command == 'run_all':
#     with open('assignment-3-801979/code/realtime_ingestion/clientstreamingingestapp', "r") as read_file:
#         config = json.load(read_file)
#     tenants = config['tenants']
#
#     tenantsappdir = "assignment-3-801979/code/realtime_ingestion/clientstreamingingestapp/"
...
if command == 'run':
    new_pid = 0
    tenant = sys.argv[2]
    with open('/home/matteo/Desktop/BigDataPlatform2/assignment-3-801979/code/realtime_ingestion/API/config_user.json', "r") as read_file:
        config = json.load(read_file)
    tenants =  config['tenants']
    print(tenants)
    tenantsappdir = "assignment-3-801979/code/realtime_ingestion/clientstreamingingestapp/"
